...
function LoginCustomer() {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full space-y-8 bg-white bg-opacity-70 p-10 rounded-xl shadow-2xl">
        <div>
          <img
          ...
          />
          <h2 className="mt-6 text-center text-3xl font-extrabold text-black"></h2>
        </div>
        <LoginForm
